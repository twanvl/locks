...
//discLimiterR = discR - 1 + C;
discLimiterR = discR - 2;
  ...
  difference() {
    ...
    group() {
      translate([-shackleWidth/2,0,shackleLength-shackleLength1]) {
        ...
        translate_z(shackleChamfer) cylinder(d=shackleDiameter,h=(lugZ-shackleTravel-2)-shackleChamfer);
      }
